  ...
  <body>
	...
	<div id="content" style="font-size:13px;">
		<div style="color: #FFFFFF; padding-top: 6px;">
			...
			<strong style="margin-left: 9px;">当前位置->会议室信息修改</strong>
		</div>
		<hr class="line"/>
  	...
  	<form method="post" name="msgform" action="/OA/alterRoom.do"> 
    <table class="table" cellspacing="0" width="100%">
    	<thead style="text-align:center; font-size: large; color: black; background-color: #dbdbda; font-family: 方正姚体;">修改会议室信息</thead>
    	<tr>
    		<td class="tableColumeHead">
    			会议室名称：
    		</td>
    		<td class="generalError">
    			<input id="rid" name="rid" type="hidden"  value="${ requestScope.rid }" />
    			<input id="rname" name="rname" type="text" style="width: 400px;" value="${ requestScope.rname }" />*<html:errors property="nameError"/>
    		</td>
    	</tr>
    	<tr>
    		<td class="tableColumeHead">
    		...
    		<td class="generalError">
    			<input id="rcontain" name="rcontain" type="text" style="width: 400px;" value="${ requestScope.rcontain }" />*<html:errors property="containError"/>
    		</td>
    	</tr>
    	<tr>
    		<td class="tableColumeHead">
    		...
    		<td>
    			<textarea id="rinfo" name="rinfo" style="width: 400px; height: 100px;" >${ requestScope.rInfo }</textarea>
    		</td>
    	</tr>
