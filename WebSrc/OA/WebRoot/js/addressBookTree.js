...
// Outputs the tree to the page ddd modified the first line 

dTree.prototype.toString = function() {

	var str = '<div class="dtree" style="width: 150px;">\n';
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
//////////////////////////////////////////////////////
		str += '<a id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="#" onclick="addAddress(\'' + node.url + '\')"';
