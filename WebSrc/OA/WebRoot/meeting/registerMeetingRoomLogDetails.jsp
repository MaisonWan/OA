  ...
  <body>
	...
	<div id="content" style="font-size:13px;">
		<div style="color: #FFFFFF; padding-top: 6px;">
			...
			<strong style="margin-left: 9px;">当前位置->会议室申请详情</strong>
		</div>
		<hr class="line"/>
		...
		<div class="right" id="rightPanel">
  				...
  				<logic:present name="roomRegDetails">
	    <table class="table" width="100%" cellspacing="0">
	    <thead style="text-align:center; font-size: large; color: black; background-color: #dbdbda; font-family: 方正姚体;">会议申请详细信息</thead>
	    <tr>
	    	<td class="tableColumeHead" style="width: 150px;">地点</td>
	    	<td>${ roomRegDetails.room.RName }</td>
	    </tr>
	    <tr>
	    	<td class="tableColumeHead">开始时间</td>
	    	<td>${ roomRegDetails.rrBegintime }</td>
	    </tr>
	    <tr>
	    	<td class="tableColumeHead">结束时间</td>
	    	<td>${ roomRegDetails.rrEndtime }</td>
	    </tr>
	    <tr>
	    	<td class="tableColumeHead">主题</td>
	    	<td>${ roomRegDetails.rrTitle }</td>
	    </tr>
	    <tr>
	    	<td class="tableColumeHead">内容</td>
	    	<td>${ roomRegDetails.rrContent }</td>
	    </tr>
	    <tr>
	    	<td colspan="2">
	    			<a href="${ requestScope.forwardString }" class="link">返回</a>
	    	</td>
	    </tr>
  	...
  	<logic:notPresent name="roomRegDetails">
