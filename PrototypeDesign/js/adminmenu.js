// JavaScript Document
	...
	if(thismenuitem.pos=="0"){
		...
		mpmenu1=new mMenu('首页','../sysman/home.html','self','','','','');
		
		mpmenu2=new mMenu('部门管理','#','self','','','','');
		mpmenu2.addItem(new mMenuItem('添加部门','../sysman/addDept.html','self',false,'','','','',''));
		mpmenu2.addItem(new mMenuItem('部门查看','../sysman/deptArran.html','self',false,'','','','',''));
		
		
		mpmenu3=new mMenu('角色管理','#','self','','','','');
		mpmenu3.addItem(new mMenuItem('添加角色','../sysman/addNewRole.html','self',false,'','','','',''));
		mpmenu3.addItem(new mMenuItem('角色分配','../sysman/roleArran.html','self',false,'','','','',''));
		mpmenu3.addItem(new mMenuItem('角色管理','../sysman/roleManage.html','self',false,'','','','',''));

		mpmenu4=new mMenu('权限管理','#','self','','','','');
		mpmenu4.addItem(new mMenuItem('新建权限','../sysman/newProperty.html','self',false,'','','','',''));
		mpmenu4.addItem(new mMenuItem('权限管理','../sysman/alterProperty.html','self',false,'','','','',''));
		
		mpmenu4=new mMenu('会议管理','#','self','','','','');
		mpmenu4.addItem(new mMenuItem('新增会议室','../adminmeeting/roomadd.html','self',false,'','','','',''));
		mpmenu4.addItem(new mMenuItem('会议室管理','../adminmeeting/managerroom.html','self',false,'','','','',''));
		mpmenu4.addItem(new mMenuItem('预约审批','../adminmeeting/managermeeting.html','self',false,'','','','',''));
		mpmenu4.addItem(new mMenuItem('会议使用报表','../adminmeeting/outputmeeting.html','self',false,'','','','',''));
