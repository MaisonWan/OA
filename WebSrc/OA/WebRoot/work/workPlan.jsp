	...
	<div id="content" style="font-size:13px;">
		...
		<div class="right" id="rightPanel">
  		<logic:present name="schList">
    		<table class="shorterTable"  cellspacing="0">
			<thead style="text-align:center; font-size: large; color: black; background-color: #dbdbda; font-family: 方正姚体;">日程安排</thead>
			<tr align="right">
				<td colspan="6"><a href="./newWorkConfig.do" class="link">添加新的日程安排</a></td>
			</tr>
			<tr align="center"  >
				<td class="tableColumeHead" >日程安排</td>
				<td class="tableColumeHead" >日期段</td>
				<td class="tableColumeHead" >时间段</td>
		 ...
		 <tr align="center" height="22px" onmouseover="this.style.backgroundColor = '#ffffff';" onmouseout="this.style.backgroundColor = '#fefccc';">
				...
				<td width="190"><bean:write name="list" property="schBegintime" format="yyyy/MM/dd"/>-
				<bean:write name="list" property="schEndtime" format="yyyy/MM/dd"/></td>
				<td width="137"><bean:write name="list" property="schBegintime" format="HH:mm"/>
				...
				<td width="127">
					<c:if test="${ list.schComplete == '0'}">
						...
						<a href="./DeleteWorkPlan.do?id=${ list.schId }" onclick="if(confirm('确认删除')){location.href='Home.do';}">删除</a>				
					</c:if>
