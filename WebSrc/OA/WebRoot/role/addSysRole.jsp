  ...
  <body>
	...
	<div id="content" style="font-size:13px;">
		<div style="color: #FFFFFF; padding-top: 6px;">
			...
			<strong style="margin-left: 9px;">当前位置->添加系统角色</strong>
		</div>
		<hr class="line"/>
		...
		<div class="right" id="rightPanel">
  				...
  				<form action="addSysRole.do" method="post"> 
	<table class="table" width="100%" cellspacing="0" style="height: auto;">
	<thead style="text-align:center; font-size: large; color: black; background-color: #dbdbda; font-family: 方正姚体;">添加新的系统角色</thead>
	<tr>
		<td class="tableColumeHead" style="width: 50px;">角色名</td>
		<td class="generalError"><input type="text" style="width: 200px;" value="${requestScope.form.sr_name}" name="sr_name"/>*<html:errors property="sr_name"/></td>
	</tr>
	<tr>
		...
		<div style="overflow: scroll; height: 230px;">
			<logic:present name="spList">
				<logic:iterate id="spt" name="sptList" type="com.icss.hit.hibernate.vo.SysPowerType">
				<c:if test="${spt.sptId != 3}">
					<bean:write name="spt" property="sptName"/><br/>
					<logic:iterate id="sp" name="spList" type="com.icss.hit.hibernate.vo.SysPower">	
						<c:if test="${ spt.sptId==sp.sysPowerType.sptId}" >
						<input type="checkbox" name="sp_name" value="<bean:write name="sp" property="spId"/>"/>
						<bean:write name="sp" property="spName"/><br/>
						</c:if>
					</logic:iterate>
					<br/>
					</c:if>
			...
			<font class="generalError">*<html:errors property="sp_name"/></font>
		</td>
	</tr>
		<td colspan="2">
