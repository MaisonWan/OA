  ...
  <body>
	...
	<div id="content" style="font-size:13px;">
		<div style="color: #FFFFFF; padding-top: 6px;">
			...
			<strong style="margin-left: 9px;">当前位置->新增会议室</strong>
		</div>
		<hr class="line"/>
		...
		<div class="right" id="rightPanel">
  			...
  			<form method="post" action="AddMeetingRoom.do">
	  			<table width="100%" class="table" cellspacing="0">
	  			<thead style="text-align:center; font-size: large; color: black; background-color: #dbdbda; font-family: 方正姚体;">添加新的会议室</thead>
		  			<tr>
		  				<td style="width: 100px;" class="tableColumeHead">会议室名称</td>
		  				<td class="generalError">
		  					<input type="text" name="room_name" style="width: 400px;" value="${requestScope.form.room_name}"/>*<html:errors property="roomNameNull"/><html:errors property="roomNameTooLong"/><html:errors property="roomNameExist"/>
		  				</td>
		  			</tr>
		  			<tr>
		  				<td class="tableColumeHead">可容纳人数</td>
		  				<td class="generalError">
		  					<input type="text" name="room_capacity" style="width: 400px;" value="${requestScope.form.room_capacity }"/>*<html:errors property="roomCapacityNull"/><html:errors property="roomCapacityNotNumic"/>
		  				</td>
		  			</tr>
		  			<tr>
		  				<td class="tableColumeHead">备注</td>
		  				<td>
		  					<textarea rows="5" style="width: 400px;"  name="room_describe">${requestScope.form.room_describe }</textarea><html:errors property="roomDescribeTooLong"/>
		  				</td>
		  			</tr>
		  			<tr>
		  				<td colspan="2">
