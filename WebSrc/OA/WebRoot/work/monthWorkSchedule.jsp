...
<html>
  ...
  <body>
	...
	<logic:present name="MonthOfSearch">
		<logic:iterate id="date" name="MonthOfSearch">
		   <bean:write name="date" format="yyyy/MM" />
		</logic:iterate>
	</logic:present>
	每月安排
	</thead>
		...
		<tr align="center"  >
		 ...
		 <tr align="center" height="22px" onmouseover="this.style.backgroundColor = '#ffffff';" onmouseout="this.style.backgroundColor = '#fefccc';">
				<td >
					<a href="../WorkPlanDetail.do?id=${ list.schId }">${ list.schTitle }</a></td>
